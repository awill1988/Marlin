...
#define STRING_CONFIG_H_AUTHOR "(@awill1988, CR-10S)" // Who made the changes.
...
/**
 * default is  { 80, 80, 400, 95 }
 * calibrated using (default) * 1000 / actual feed length for 100mm test
 * the result is 137.68 from 69mm test run
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 137.68 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET {-42, 0, -2.76}
...
#define X_MIN_POS -1 // 4 after my modification, micro swiss recommends -5, so -1
#define Y_MIN_POS -8 // 2 after my modification, micro swiss recommends -10, so -8
#define Z_MIN_POS 0
